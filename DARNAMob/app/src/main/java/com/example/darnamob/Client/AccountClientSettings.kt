...
class AccountClientSettings : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.save.setOnClickListener {
            phone = findViewById<EditText>(R.id.art_phone).text.toString()
            address = findViewById<EditText>(R.id.art_address).text.toString()
            db.editProfileMember(userID, phone, address, membre.image)
        }
